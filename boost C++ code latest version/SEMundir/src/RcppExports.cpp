...
RcppExport SEXP SEMundir_rowsum_Mat(SEXP MSEXP) {
BEGIN_RCPP
...
RcppExport SEXP SEMundir_colsum_Mat(SEXP MSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< mat >::type M(MSEXP);
...
RcppExport SEXP SEMundir_epan(SEXP inputSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP SEMundir_gamma_update_undir(SEXP gammaSEXP, SEXP piSEXP, SEXP thetaSEXP, SEXP networkSEXP, SEXP NSEXP, SEXP KSEXP, SEXP T_gridSEXP, SEXP grid_idsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP SEMundir_grad_SEM_undir(SEXP theta_uSEXP, SEXP networkSEXP, SEXP NSEXP, SEXP KSEXP, SEXP nonzero_idsSEXP, SEXP nonzero_ids_lenSEXP, SEXP cluster_idsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(grad_SEM_undir(theta_u, network, N, K, nonzero_ids, nonzero_ids_len, cluster_ids));
    return rcpp_result_gen;
END_RCPP
}
// hess_SEM_undir
...
RcppExport SEXP SEMundir_hess_SEM_undir(SEXP theta_uSEXP, SEXP NSEXP, SEXP KSEXP, SEXP T_dataSEXP, SEXP bandwidthSEXP, SEXP data_idsSEXP, SEXP grid_idsSEXP, SEXP grid_id_indexSEXP, SEXP cluster_idsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< vec >::type theta_u(theta_uSEXP);
    ...
    Rcpp::traits::input_parameter< vec >::type cluster_ids(cluster_idsSEXP);
    rcpp_result_gen = Rcpp::wrap(hess_SEM_undir(theta_u, N, K, T_data, bandwidth, data_ids, grid_ids, grid_id_index, cluster_ids));
    return rcpp_result_gen;
END_RCPP
}
// ELBO_conv_SEM_undir
...
RcppExport SEXP SEMundir_ELBO_conv_SEM_undir(SEXP gammaSEXP, SEXP piSEXP, SEXP theta_uSEXP, SEXP networkSEXP, SEXP NSEXP, SEXP KSEXP, SEXP T_dataSEXP, SEXP bandwidthSEXP, SEXP data_idsSEXP, SEXP grid_idsSEXP, SEXP grid_id_indexSEXP, SEXP cluster_idsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< mat >::type gamma(gammaSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type grid_id_index(grid_id_indexSEXP);
    Rcpp::traits::input_parameter< vec >::type cluster_ids(cluster_idsSEXP);
    rcpp_result_gen = Rcpp::wrap(ELBO_conv_SEM_undir(gamma, pi, theta_u, network, N, K, T_data, bandwidth, data_ids, grid_ids, grid_id_index, cluster_ids));
    return rcpp_result_gen;
END_RCPP
}

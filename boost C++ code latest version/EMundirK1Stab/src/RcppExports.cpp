...
RcppExport SEXP EMundirK1Stab_rowsum_Mat(SEXP MSEXP) {
BEGIN_RCPP
...
RcppExport SEXP EMundirK1Stab_colsum_Mat(SEXP MSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< mat >::type M(MSEXP);
...
RcppExport SEXP EMundirK1Stab_epan(SEXP inputSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// grad_EM_undir_K1_Stab
vec grad_EM_undir_K1_Stab(float theta_u, cube network, int N, int K, int T_grid);
RcppExport SEXP EMundirK1Stab_grad_EM_undir_K1_Stab(SEXP theta_uSEXP, SEXP networkSEXP, SEXP NSEXP, SEXP KSEXP, SEXP T_gridSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(grad_EM_undir_K1_Stab(theta_u, network, N, K, T_grid));
    return rcpp_result_gen;
END_RCPP
}
// hess_EM_undir_K1_Stab
...
RcppExport SEXP EMundirK1Stab_hess_EM_undir_K1_Stab(SEXP theta_uSEXP, SEXP NSEXP, SEXP KSEXP, SEXP T_dataSEXP, SEXP bandwidthSEXP, SEXP data_idsSEXP, SEXP grid_idsSEXP, SEXP grid_id_indexSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< float >::type theta_u(theta_uSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(hess_EM_undir_K1_Stab(theta_u, N, K, T_data, bandwidth, data_ids, grid_ids, grid_id_index));
    return rcpp_result_gen;
END_RCPP
}
// ELBO_conv_EM_undir_K1_Stab
...
RcppExport SEXP EMundirK1Stab_ELBO_conv_EM_undir_K1_Stab(SEXP theta_uSEXP, SEXP networkSEXP, SEXP NSEXP, SEXP KSEXP, SEXP T_dataSEXP, SEXP bandwidthSEXP, SEXP data_idsSEXP, SEXP grid_idsSEXP, SEXP grid_id_indexSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< float >::type theta_u(theta_uSEXP);
    ...
    Rcpp::traits::input_parameter< vec >::type grid_ids(grid_idsSEXP);
    Rcpp::traits::input_parameter< int >::type grid_id_index(grid_id_indexSEXP);
    rcpp_result_gen = Rcpp::wrap(ELBO_conv_EM_undir_K1_Stab(theta_u, network, N, K, T_data, bandwidth, data_ids, grid_ids, grid_id_index));
    return rcpp_result_gen;
END_RCPP
}
// grad_ELBO_K1_CV
vec grad_ELBO_K1_CV(float theta_u, vec gamma, cube network, int N, int K, int T_data, int test_node_set_len);
RcppExport SEXP EMundirK1Stab_grad_ELBO_K1_CV(SEXP theta_uSEXP, SEXP gammaSEXP, SEXP networkSEXP, SEXP NSEXP, SEXP KSEXP, SEXP T_dataSEXP, SEXP test_node_set_lenSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< float >::type theta_u(theta_uSEXP);
...
RcppExport SEXP EMundirK1Stab_hess_ELBO_K1_CV(SEXP theta_uSEXP, SEXP gammaSEXP, SEXP networkSEXP, SEXP NSEXP, SEXP KSEXP, SEXP T_dataSEXP, SEXP bandwidthSEXP, SEXP data_idsSEXP, SEXP grid_idsSEXP, SEXP grid_id_indexSEXP, SEXP test_node_set_lenSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< float >::type theta_u(theta_uSEXP);
...
RcppExport SEXP EMundirK1Stab_ELBO_conv_K1_CV(SEXP gammaSEXP, SEXP piSEXP, SEXP theta_uSEXP, SEXP networkSEXP, SEXP NSEXP, SEXP KSEXP, SEXP T_dataSEXP, SEXP bandwidthSEXP, SEXP data_idsSEXP, SEXP grid_idsSEXP, SEXP grid_id_indexSEXP, SEXP test_node_set_lenSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< vec >::type gamma(gammaSEXP);

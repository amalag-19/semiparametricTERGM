...
// [[Rcpp::export]]
mat grad_EM_undir(vec theta_u, mat gamma, cube network, int N, int K, vec nonzero_ids, int nonzero_ids_len){
...
// [[Rcpp::export]]
mat hess_EM_undir(vec theta_u, mat gamma, int N, int K, int T_data, float bandwidth, vec data_ids, vec grid_ids, int grid_id_index){
    cube t1(K,K,T_data);
...
// [[Rcpp::export]]
float ELBO_conv_EM_undir(mat gamma, vec pi, vec theta_u, cube network, int N, int K, int T_data, float bandwidth, vec data_ids, vec grid_ids, int grid_id_index){
